...
<li><p style="color:var(--global-text-color)"><span class="font-weight-bold" style="color:var(--global-theme-color)">Long, Y</span>, Cao, G., Kepplinger, D., and Wang, L. (2025+). <a class="font-weight-bold" href="https://www3.stat.sinica.edu.tw/ss_newpaper/SS-2024-0402_na.pdf">Robust Mean Signal Estimation and Inference for Imaging Data.</a> <i>Statistica Sinica</i>, Accepted. </p></li>
